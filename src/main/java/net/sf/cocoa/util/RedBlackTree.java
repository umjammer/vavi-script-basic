 ...
 */
class RedBlackTreeEnumerator<T> implements Enumeration<T> {
     ...
     */
    RedBlackTreeEnumerator(RedBlackTree<T> tree, boolean keys) {
        this.tree = tree;
        this.keys = keys;
        this.x = tree.minimum();
