...
public class BasicScriptEngine implements ScriptEngine {
    ...
    /** */
    private static final String MY_NAME = "Cocoa BASIC";
    /** */
    ...
    public Object eval(String script, ScriptContext context) throws ScriptException {
        try {
            ByteArrayInputStream reader = new ByteArrayInputStream(script.getBytes());
            interpreter.setInputStream(reader);
