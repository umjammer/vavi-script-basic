...
public class ConsoleWindow extends Frame {
    ...
    String[] fonts;
    static final String[] styles = {"Plain", "Bold", "Italic"};
    static final String[] sizes = {"8", "9", "10", "12", "14", "16", "18", "24"};
    String clipboard;
...
// Handle component events
    ...
    public boolean action(Event evt, Object obj) {
        ...
        if (label.equals("Open...")) {
            ...
            dialog.show();
            file = dialog.getDirectory() + File.separator + dialog.getFile();
