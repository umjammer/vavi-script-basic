...
import com.github.namazu.core.ValueType;
...
public class ExprNode extends Node {
    ...
    // Exprに含まれうる字句
    private static final Set<LexicalType> allowSet = new HashSet<LexicalType>() {
        {
    ...
    public boolean isOpe(LexicalType lt) {
        Set<LexicalType> opeSet = new HashSet<LexicalType>() {
            {
                add(LexicalType.ADD);
                add(LexicalType.SUB);
                add(LexicalType.DIV);
